...
realism_config = dnnlib.EasyDict(minibatch_size=8, num_images=40000, num_gen_images=800, show_n_images=64,
                                 truncation=1.0, save_images=True, save_path=SAVE_PATH, num_gpus=1,
                                 random_seed=123456) #num_images=2000, num_gen_images=40, show_n_images=40

truncation_config = dnnlib.EasyDict(minibatch_size=8, num_images=40000, truncations=[1.0, 0.7, 0.3],
