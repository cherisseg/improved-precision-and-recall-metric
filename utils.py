...
def initialize_stylegan():
    ...
    network_path = '/mnt/lustre/users/cgovender/results/baseline/lamps/00002-sgan-lamps_128-2gpu-mixing-regularization-mix90-stylebased-8/network-snapshot-006026.pkl'#stylegan.pkl trained network
