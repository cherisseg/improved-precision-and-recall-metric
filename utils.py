...
def initialize_stylegan():
    ...
    network_path = '/mnt/lustre/users/cgovender/results/baseline/lamps/00000-sgan-lamps_128-2gpu-mixing-regularization-mix90-stylebased-8/network-snapshot-001283.pkl'#stylegan.pkl trained network
