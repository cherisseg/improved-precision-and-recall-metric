...
def initialize_stylegan():
    ...
    network_path = '/mnt/lustre/users/cgovender/results/baseline/chairs_edited/00000-sgan-chairs_128_edited-2gpu-mixing-regularization-mix90-stylebased-8/network-snapshot-005486.pkl'#stylegan.pkl trained network
