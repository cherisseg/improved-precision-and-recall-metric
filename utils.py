...
def initialize_stylegan():
    ...
    network_path = '/mnt/lustre/users/cgovender/results/baseline/chairs/00001-sgan-chairs_128-2gpu-mixing-regularization-mix90-stylebased-8/network-snapshot-005065.pkl'#stylegan.pkl trained network
