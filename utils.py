...
def initialize_stylegan():
    ...
    network_path = '/mnt/lustre/users/cgovender/results/baseline/tables/00002-sgan-tables_128-2gpu-mixing-regularization-mix90-stylebased-8/network-snapshot-008127.pkl'#stylegan.pkl trained network
